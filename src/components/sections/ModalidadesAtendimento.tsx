...
export default function ModalidadesAtendimento() {
  ...
  return (
    <section
      id="atendimentos"
      className="relative overflow-hidden px-5 py-20 md:px-8 md:py-28 lg:py-32"
    >
      ...
      >
        <svg
          className="absolute left-1/2 top-1/2 h-[80%] w-[70%] -translate-x-1/2 -translate-y-1/2"
          viewBox="0 0 700 700"
          fill="none"
        >
          <defs>
            ...
            <ModalidadeCard variant="accent">
              <div className="flex h-full flex-col p-8 md:p-10 lg:p-12">
                <div className="mb-7 flex items-center gap-3">
                  ...
                  <p className="text-[10px] uppercase tracking-[1.8px] text-vinho/70 font-medium">
                    Presencial
                  </p>
                </div>
                ...
                <div className="space-y-4 text-[15px] leading-[1.75] text-cacau/85">
                  <p>
                    O consultório é pensado para oferecer um ambiente
                    reservado, silencioso e acolhedor — onde cada encontro
                    acontece com tempo e privacidade. As sessões presenciais
                    são conduzidas na{" "}
                    <strong className="font-semibold text-vinho">
                      Região Central de Belo Horizonte
                    </strong>
                    , atendendo crianças, adolescentes e adultos.
                  </p>
                  <p>
                    O endereço completo é compartilhado após a confirmação do
                    agendamento, junto às orientações de acesso.
                  </p>
                </div>
                <div className="mt-auto flex items-center gap-3 border-t border-vinho/15 pt-6 mt-8">
                  <MapPin
                    size={16}
                    strokeWidth={1.5}
                    className="flex-shrink-0 text-vinho/70"
                    aria-hidden="true"
                  />
                  <p className="text-[11px] uppercase tracking-[1.5px] text-taupe">
                    Consultório físico · Belo Horizonte
                  </p>
                </div>
              </div>
            </ModalidadeCard>
          ...
          >
            <ModalidadeCard>
              <div className="flex h-full flex-col p-8 md:p-10 lg:p-12">
                ...
                <div className="space-y-4 text-[15px] leading-[1.75] text-cacau/85">
                  <p>
                    As sessões acontecem por{" "}
                    <strong className="font-semibold text-vinho">
                      videochamada em plataforma segura
                    </strong>
                    , com o mesmo sigilo e a mesma atenção do atendimento
                    presencial. É uma opção pensada para quem precisa de
                    flexibilidade de horários ou está fora da região do
                    consultório.
                  </p>
                  <p>
                    Para adolescentes, o formato online é avaliado em uma{" "}
                    <strong className="font-semibold text-vinho">
                      conversa prévia
                    </strong>{" "}
                    com os responsáveis, garantindo que o cuidado aconteça da
                ...
                <div className="mt-auto flex items-center gap-3 border-t border-taupe/20 pt-6 mt-8">
                  <Video
                    size={16}
                    strokeWidth={1.5}
                    className="flex-shrink-0 text-taupe"
                    aria-hidden="true"
                  />
                  <p className="text-[11px] uppercase tracking-[1.5px] text-taupe">
